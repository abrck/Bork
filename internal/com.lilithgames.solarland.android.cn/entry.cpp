...
void __attribute__((constructor)) init()
{
    ...
    while (GameData::GEngine <= 0)
    {
        GameData::GEngine = *(uintptr_t*)(Globals::libUE4 + Offsets::GEngine);
    ...
    {
        GameData::GameViewport = *(uintptr_t*)(GameData::GEngine + Offsets::GameViewport);
